import { c as createComponent } from './consts_C9BUAdWh.mjs';
import 'piccolore';
import { c as createRenderInstruction, r as renderComponent, b as renderTemplate, m as maybeRenderHead, d as addAttribute } from './entrypoint_-VAv5VyE.mjs';
import { g as getCollection, $ as $$Layout } from './_astro_content_R6h59BC6.mjs';
...
</p> <div class="quests-block" data-astro-cid-j7pv25f6> <h2 class="quests-heading" data-astro-cid-j7pv25f6>Main quests</h2> <ul class="quest-list" data-astro-cid-j7pv25f6> <li data-astro-cid-j7pv25f6>&rarr; Placeholder main quest. Suneel to provide.</li> <li data-astro-cid-j7pv25f6>&rarr; Placeholder main quest. Suneel to provide.</li> <li data-astro-cid-j7pv25f6>&rarr; Placeholder main quest. Suneel to provide.</li> </ul> </div> <div class="quests-block" data-astro-cid-j7pv25f6> <h2 class="quests-heading" data-astro-cid-j7pv25f6>Side and past quests</h2> <ul class="quest-list" data-astro-cid-j7pv25f6> <li data-astro-cid-j7pv25f6>&rarr; Placeholder past quest. Suneel to provide.</li> <li data-astro-cid-j7pv25f6>&rarr; Placeholder past quest. Suneel to provide.</li> <li data-astro-cid-j7pv25f6>&rarr; Placeholder past quest. Suneel to provide.</li> </ul> </div> </div> <div class="hero-right" data-astro-cid-j7pv25f6> <!-- Video / Photo area --> <div class="video-frame" data-astro-cid-j7pv25f6> <!-- Fallback image shown until video loads --> <img src="https://res.cloudinary.com/de0frkjm7/image/upload/w_600,h_800,c_fill,g_face/v1773947883/designer_jteewz.jpg" alt="Suneel Armstrong" class="video-el hero-img" style="opacity:1" data-astro-cid-j7pv25f6> <video id="loop-vid" src="https://res.cloudinary.com/de0frkjm7/video/upload/v1773947799/rest-suneel_ohxtgq.mp4" autoplay loop muted playsinline class="video-el" style="opacity:0" data-astro-cid-j7pv25f6></video> <video id="backflip-vid" src="https://res.cloudinary.com/de0frkjm7/video/upload/v1773947799/backflip-suneel_lalng5.mp4" muted playsinline class="video-el" style="opacity:0" data-astro-cid-j7pv25f6></video> </div> <div class="btn-wrap" data-astro-cid-j7pv25f6> <button id="backflip-btn" class="pill-btn" data-astro-cid-j7pv25f6>Backflip</button> </div> </div> </section> <!-- ======================================================
         FEATURED WORK
    ====================================================== --> <section class="section" data-astro-cid-j7pv25f6> <div class="section-head" data-astro-cid-j7pv25f6> <h2 class="section-title" data-astro-cid-j7pv25f6>Featured Work</h2> <a href="#" class="pill-outline" data-astro-cid-j7pv25f6>see all &rarr;</a> </div> <div class="work-list" data-astro-cid-j7pv25f6> ${projects.map((project) => renderTemplate`<a${addAttribute(`/work/${project.id}`, "href")} class="work-card" data-astro-cid-j7pv25f6> <div class="work-thumb" data-astro-cid-j7pv25f6> ${project.data.thumbnail ? renderTemplate`<img${addAttribute(project.data.thumbnail, "src")}${addAttribute(project.data.title, "alt")} data-astro-cid-j7pv25f6>` : renderTemplate`<span class="ph-label" data-astro-cid-j7pv25f6>Image</span>`} </div> <div class="work-info" data-astro-cid-j7pv25f6> <div data-astro-cid-j7pv25f6> <h3 class="work-title" data-astro-cid-j7pv25f6>${project.data.title}</h3> <p class="work-desc" data-astro-cid-j7pv25f6>${project.data.description}</p> </div> <div class="work-actions" data-astro-cid-j7pv25f6> ${project.data.watchLink && renderTemplate`<a${addAttribute(project.data.watchLink, "href")} target="_blank" rel="noopener noreferrer" class="ext-icon" onclick="event.stopPropagation()" title="Watch" data-astro-cid-j7pv25f6> <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-j7pv25f6> <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" data-astro-cid-j7pv25f6></path> <polyline points="15 3 21 3 21 9" data-astro-cid-j7pv25f6></polyline> <line x1="10" y1="14" x2="21" y2="3" data-astro-cid-j7pv25f6></line> </svg> </a>`} </div> </div> </a>`)} </div> </section> <!-- ======================================================
         I WRITE (Thoughts)
